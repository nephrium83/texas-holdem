...
3. Detection-first remains the v1 default while the full prevention path is benchmarked and optimized. Prevention remains available as an explicit opt-in.
